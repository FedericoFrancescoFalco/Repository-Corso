...
CREATE TABLE Prenotazione (
    ...
    evento INTEGER NOT NULL,
    PRIMARY KEY(id),
    FOREIGN KEY (posto_id, fila, colonna, settore) REFERENCES Posto(id, fila, colonna, settore),
    FOREIGN KEY (evento) REFERENCES Evento(id)
);
...
CREATE TABLE PrePosto (
    ...
    FOREIGN KEY (posto, fila, colonna, settore) REFERENCES Posto(id, fila, colonna, settore)
);
...
CREATE TABLE Spettacolo (
    ...
    tipologiaSpettacolo INTEGER NOT NULL,
    genere INTEGER NOT NULL,
    artista INTEGER NOT NULL,
    evento INTEGER NOT NULL,
    PRIMARY KEY(id),
    FOREIGN KEY (tipologiaSpettacolo) REFERENCES TipologiaSpettacolo(id),
